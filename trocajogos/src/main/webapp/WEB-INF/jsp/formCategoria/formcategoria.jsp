...
<html lang="pt-br">
    <head>
        ...
        <title>TrocaJogos - Form Categoria</title>
                    ...
                    <div class="row justify-content-md-center mb-5 text-center">
                        <div class="col-md-12 align-self-center text-center">
                            <div class="form-group input-login mx-auto">
                                <input name="categoria.nome" value="${categoria.nome}" minlength="2" maxlength="100" class="form-control" id="email" type="text" placeholder="Nome *" required="required" data-validation-required-message="Nome da Categoria" />
